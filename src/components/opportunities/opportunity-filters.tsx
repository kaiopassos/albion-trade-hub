      ...
      <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`flex items-center gap-1.5 rounded-lg px-4 py-2 text-sm font-medium transition-all ${
                type === tab.id
                  ...
                  : "text-[#8b7635] hover:bg-[#1e2230] hover:text-[#a89878] border border-transparent"
              }`}
            >
              <span>{tab.icon}</span>
              {tab.label}
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            type="number"
            placeholder="0%"
            className="w-20 rounded-lg border border-[#2a2f3e] bg-[#12151e] px-2 py-1.5 text-sm text-[#e8dcc8] focus:border-[#c8a84e] focus:outline-none"
            value={minMargin}
